...
#forest_data <- read_csv("data/forest/nuts_modified_RCP4_5-SSP4-0-99-UK-Cell-2020.csv", show_col_types = FALSE)
...
# UI
ui <- fluidPage(
  titlePanel("Future Climate and Forest Data per NUTS2 Region"),
  sidebarLayout(
    sidebarPanel(
      radioButtons("data_type", "Select Data Type:", choices = c(
        "Climate Data 30 Year Climatologies" = "climate",
        "Climate Data 10 Year Climatologies (Not Bias-Corrected)" = "climate10",
        "Forest Data" = "forest"
      )),
      conditionalPanel(
      ...
      conditionalPanel(
        ...
        selectInput("scenario", "Select Climate Scenario:", choices = unique(forest_data$scenario))
      ),
